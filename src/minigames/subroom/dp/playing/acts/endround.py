...
class PostRound():
        ...
        for player in players_classes:
            ...
            if "ROUBOVIDA" in player_class.positive_effects:
                ...
                if rounds == 0:
                    ...
                    player_class.positive_effects["ROUBOVIDA"]["ROUNDS"] = rounds
            ...
            if "ENVENENADO" in player_class.negative_effects:
                ...
                if rounds == 0:
                    ...
                    player_class.negative_effects["ENVENENADO"]["ROUNDS"] = rounds
        ...
        for player in team:
            ...
            for negative in negative_effects:
                if negative == "ATORDOADO":
                    ...
                    format_negative.append(f"Queimado")
                elif negative == "ENVENENADO":
                    format_negative.append(f"Envenenado")
    ...
    def final_code_func(self):
        final_code = "Equipe 1:\n"
        final_code = self.alive_players_final_code(self.team1_classes, final_code)
